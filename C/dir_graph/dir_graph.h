...
typedef void (*dir_graph_display_graph) (dir_graph_t* t_graph);
typedef int (*dir_graph_dfs_fnptr) (dir_graph_t *t_graph, graph_V_t* v);


int graph_run_dfs(dir_graph_t* t_graph, dir_graph_dfs_fnptr);
int graph_dfs_visit(dir_graph_t* t_graph, graph_V_t* v);
int graph_dfs_visit_detect_DAG(dir_graph_t* t_graph, graph_V_t* v);
